        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (Auth::user()->rol == 'admin')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('logisticsCenters.list')" :active="request()->routeIs('logisticsCenters.list')">
...
{{-- Empleado---------------------------------------------------------------------------------------------------------------------------------------------- --}}
                @elseif (Auth::user()->rol == 'employee')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('movement.list')" :active="request()->routeIs('movement.list')">
                            {{ __('Movements') }}
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('locate')" :active="request()->routeIs('locate')">
                            {{ __('Locate Item') }}
                        </x-nav-link>
                    </div>
                @endif
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('logisticsCenters.list')" :active="request()->routeIs('logisticsCenters.list')">
                {{ __('Logistics Centers') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-gray-500">{{ Auth::user()->user }}</div>
            </div>
